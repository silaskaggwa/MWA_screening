...
var ExamComponent = /** @class */ (function () {
    ...
    ExamComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.examService.retrieveExam()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["reduce"])(function (acc, cur) {
            acc.push(cur);
            return acc;
        }, []))
    ...
    ExamComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_exam_service__WEBPACK_IMPORTED_MODULE_1__["ExamService"]])
    ], ExamComponent);
...
var ExamService = /** @class */ (function () {
    ...
    ExamService.prototype.postSnapshot = function (info) {
        return this.http.patch(this.domain + '/exam', info);
    };
